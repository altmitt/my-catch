...
class RootViewController: UIViewController, UIPageViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let startingViewController: SlideViewController = self.modelController.viewControllerAtIndex(0, storyboard: self.storyboard!)!
    ...
    func pageViewController(_ pageViewController: UIPageViewController, spineLocationFor orientation: UIInterfaceOrientation) -> UIPageViewControllerSpineLocation {
        ...
        let currentViewController = self.pageViewController!.viewControllers![0] as! SlideViewController
